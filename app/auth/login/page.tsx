    ...
    <div className="min-h-screen flex items-center justify-center px-4 sm:px-6 py-8 overflow-y-auto relative" style={{ background: 'linear-gradient(to bottom right, #C5459C, #C5459C, #932B74)' }}>
      ...
      <div className="w-full max-w-[400px] relative z-10 my-auto">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-sm text-white/90 font-medium">Your Personal Taste Recommender</p>
        </div>

        {/* Login Form */}
        <div className="bg-white rounded-3xl p-5 sm:p-7 shadow-2xl">
          <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-4 sm:mb-6 text-center">Welcome Back! 👋</h2>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-3">
            ...
            <button
              ...
              className="w-full py-2.5 sm:py-3 rounded-xl font-semibold text-white hover:opacity-90 hover:shadow-md active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm mt-4 border-2"
            >
          ...
          <div className="text-center mt-3">
            <Link href="/auth/forgot-password" className="text-xs text-gray-600 hover:text-primary font-semibold transition-colors">
              Forgot Password?
            </Link>
          </div>
          ...
          <div className="mt-4 sm:mt-5 text-center">
            <p className="text-gray-600 text-xs">
              ...
              <Link href="/auth/signup" className="text-primary font-bold hover:text-primary-700 transition-colors">
                Sign Up
              </Link>
            </p>
          </div>
