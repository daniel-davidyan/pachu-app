        ...
        <div className="bg-white rounded-3xl p-7 shadow-2xl">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-3.5">
            ...
            <div className="text-right">
              <Link href="/auth/forgot-password" className="text-xs text-primary hover:text-primary-700 font-semibold transition-colors">
                Forgot Password?
              </Link>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 bg-gradient-to-r from-primary to-primary-600 text-white rounded-xl font-bold text-sm hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed mt-1 shadow-md"
            >
